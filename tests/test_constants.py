...
def test_scan_covers_every_module_in_the_package():
    assert {"core.py", "cli.py", "endpoints.py", "results.py", "constants.py", "models.py", "util.py", "installed.py", "pypi.py", "scanning.py", "magics.py", "localmodules.py", "accelerator.py", "resolution.py", "drift.py", "analyze.py", "generate.py"} <= set(SOURCES)
